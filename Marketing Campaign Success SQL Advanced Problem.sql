...
campaign where they see call-to-actions for more n-app purchases.
 find the numer of users that made additional in-app purchases due to the success of the marketing campaign.
 The marketing campaign doesnot start until one day after the initial in-app purchase so users that only made one or 
 multiple purchases on the first day do not count, nor do we count users that over time purchases, only the 
...
-- https://www.youtube.com/watch?v=m_oDI0bD6VQ&list=PLBTZqjSKn0IeKBQDjLmzisazhqQy4iGkb&index=48
